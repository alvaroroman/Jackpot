...
public class Main extends javax.swing.JFrame {
    ...
    Random generadorImagenes = new Random();
    double saldojugador;
    ...
    public Main() {
        ...
        //Al iniciar la pantalla los botones de la palanca y de cobrar estaran desactivados hasta que no echen monedas
   ...
   /**
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
            ...
            //En esta variable se quitará 0.50 cada vez que el jugador active la palanca
            saldojugador -= 0.50;
            jLabelSaldo.setText(saldojugador + " €");
            //Si el saldo del jugador es menor o igual que 0 la palanca y el botón de cobrar se desactivarán
            if(saldojugador <= 0){
                jButtonPalanca.setEnabled(false);
                jButtonCobrar.setEnabled(false);
            }
            ...
            for (int i = 0; i < 3; i++) {
                //Genera una imagen cada vez que le das a la palanca
                int imagen1 = generadorImagenes.nextInt(4);  
                ImageIcon imagene1 = new ImageIcon(getClass().getResource("/imagenes/" +imagen1+ ".png"));
                jLabelImagen1.setIcon(imagene1);
                int imagen2 = generadorImagenes.nextInt(4)+ 1; 
                ImageIcon imagene2 = new ImageIcon(getClass().getResource("/imagenes/" +imagen2+ ".png"));
                jLabelImagen2.setIcon(imagene2);
                int imagen3 = generadorImagenes.nextInt(4)+ 1; 
                ImageIcon imagene3 = new ImageIcon(getClass().getResource("/imagenes/" +imagen3+ ".png"));
                jLabelImagen3.setIcon(imagene3); 
            }
        //Van saliendo uno por uno
        try {    
        ...
        try {    
            jLabelImagen3.paintImmediately(0, 0, jLabelImagen3.getWidth(), jLabelImagen3.getHeight());
            Thread.sleep(300);
        } catch (InterruptedException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton50centActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton50centActionPerformed
        //En esta variable se sumará 0.50 cada vez que el jugador le de al botón de 50 cent.
        saldojugador += 0.50;
        jLabelSaldo.setText(saldojugador + " €");
    ...
    private void jButton1euroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1euroActionPerformed
        //En esta variable se sumará 1.00 cada vez que el jugador le de al botón de 1 €.
        saldojugador += 1.00;
        jLabelSaldo.setText(saldojugador + " €");
        jButtonPalanca.setEnabled(true);
        jButtonCobrar.setEnabled(true);
    ...
    private void jButton2euroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2euroActionPerformed
        //En esta variable se sumará 2.00 cada vez que el jugador le de al botón de 2 €.
        saldojugador += 2.00;
        jLabelSaldo.setText(saldojugador + " €");
        jButtonPalanca.setEnabled(true);
        jButtonCobrar.setEnabled(true);
    ...
    private void jButtonCobrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCobrarActionPerformed
        //En esta variable el saldo se pondrá en 0 cada vez que el usuario le de a cobrar..
        jLabelSaldo.setText("0,00 €");
        //Estas dos variable hacen que la palanca y el botón de cobrar se desactiven cada vez que el usuario cobre.
        jButtonPalanca.setEnabled(false);
        jButtonCobrar.setEnabled(false);
        
        jLabelImagen1.setText("");
        jLabelImagen2.setText("");
        jLabelImagen3.setText("");
